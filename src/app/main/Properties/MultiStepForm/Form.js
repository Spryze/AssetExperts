...
//     size: propertyData?.propertyData?.size || 0,
...
//     parking: propertyData?.propertyData?.parking || false,
...
//     longitude: propertyData?.propertyData?.longitude || 0,
//     latitude: propertyData?.propertyData?.latitude || 0,
//     direction: propertyData?.propertyData?.direction || "",
//     listing_type: propertyData?.propertyData?.listing_type || "",
//     loan_eligibile: propertyData?.propertyData?.loan_eligibile || false,
//     No_bed_rooms: propertyData?.propertyData?.No_bed_rooms || "",
//     govt_price: propertyData?.propertyData?.govt_price || null,
...
//     const parsedValue = ["price", "size", "latitude", "longitude","govt_price"].includes(
//       name
//     )
//       ? parseFloat(value)
//       : name === "loan_eligibile"
...
//       // const formDataToSubmit = new FormData();0
//       // Object.keys(formData).forEach((key) => {
//       //   if (key === "docFiles") {
//       //     formData[key].forEach((file) => {
//       //       formDataToSubmit.append("docFiles", file);
//       //     });
//       //   } else {
//       //     formDataToSubmit.append(key, formData[key]);
//       //   }
//       // });
//       console.log("form data submitting from frontend",formData)
...
//           />
//         </Grid>
//         {(user.role == "admin" || user.role === "staff") && (<Grid item xs={12} sm={6}>
//           <Button
//             component="label"
//             role={undefined}
//             variant="contained"
