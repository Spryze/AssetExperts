...
const ManageUserProfile = () => {
  ...
  const EditableFieldsForAddPayments = ['subscription_plan_type','transaction_id', 'payment_date','Payment_status', 'payment_gateway', 'comments'];
  ...
  const handleOrderClick = (orderId) => {
    ...
    const index = usersSearchResult?.payments.findIndex((payment) => payment.payment_id === orderId);
    if (index !== -1) {
        ...
        {value === 2 && (
          <div>
            <Paper elevation={7} style={{ padding: 20, minHeight: 600 }}>
              ...
              <MySubscriptions userid={userId} isAdmin={isAdmin} subscriptions={manageUserSubscription} />
            </Paper>
          </div>
        )}
        {/* {value === 3 && (
          ...
          >
            ...
            <DialogContent>
              ...
              <Grid container spacing={2} sx={{ mt: 2 }}>
                ...
                </FormControl>) :field.id === 'payment_date' ? (
                <FormControl fullWidth margin="normal">
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  ...
                  <DateTimePicker
                        label="Payment Date"
                    value={paymentDialogValues[field.id]}
                    onChange={(newValue) => handleDateChangeInPaymentDialog(field.id, newValue)}
                ...
                </FormControl>) : field.id === 'active_notifications' ? (
                <FormControl fullWidth margin="normal">
                  {/* <InputLabel>{field.label}</InputLabel> */}
                  <TextField
                fullWidth
